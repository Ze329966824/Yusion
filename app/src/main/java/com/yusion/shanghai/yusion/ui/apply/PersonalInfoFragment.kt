...
class PersonalInfoFragment : DoubleCheckFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        personal_info_driving_license_lin.setOnClickListener {
    ...
    fun checkCanNextStep(): Boolean {
        ...
        } else if (personal_info_driving_license_tv.text == "请上传") {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            if (requestCode == Constants.REQUEST_CONTACTS) {
                ...
                personal_info_driving_license_tv.text = if (drivingLicenseImgUrl.isNotEmpty()) "已上传" else "请上传"
            }
        }
    }
}