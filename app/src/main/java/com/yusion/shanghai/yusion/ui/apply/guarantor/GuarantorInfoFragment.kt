...
//        } else if (guarantor_info_mobile_edt.text.isEmpty()) {
...
//        } else if (guarantor_info_company_name_edt.text.isEmpty()) {
//            Toast.makeText(mContext, "单位名称不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_company_address_tv.text.isEmpty()) {
//            Toast.makeText(mContext, "单位地址不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_company_address1_tv.text.isEmpty()) {
//            Toast.makeText(mContext, "单位地址的详细地址不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_company_address2_tv.text.isEmpty()) {
//            Toast.makeText(mContext, "单位地址的门牌号不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_work_position_tv.text.isEmpty()) {
//            Toast.makeText(mContext, "职务不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_monthly_income_edt.text.isEmpty()) {
...
//        } else if (guarantor_info_house_area_edt.text.isEmpty()) {
...
//        } else if (guarantor_info_urg_contact1_edt.text.isEmpty()) {
//            Toast.makeText(mContext, "亲属联系人姓名不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_urg_mobile1_edt.text.isEmpty()) {
//            Toast.makeText(mContext, "亲属联系人手机号不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_urg_relation1_tv.text.isEmpty()) {
//            Toast.makeText(mContext, "亲属联系人与申请人关系不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_urg_contact2_edt.text.isEmpty()) {
//            Toast.makeText(mContext, "其他联系人姓名不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_urg_mobile2_edt.text.isEmpty()) {
//            Toast.makeText(mContext, "其他联系人手机号不能为空", Toast.LENGTH_SHORT).show()
//        } else if (guarantor_info_urg_relation2_tv.text.isEmpty()) {
